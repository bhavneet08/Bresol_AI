...
class ForgotOtpVerificationScreen extends StatefulWidget {
  final String userInput; // email or phone
  const ForgotOtpVerificationScreen({super.key, required this.userInput});
...
class _ForgotOtpVerificationScreenState extends State<ForgotOtpVerificationScreen>
  ...
  Timer? _timer;
  int _remainingSeconds = 30; // OTP valid for 30 seconds
...
// 🔄 Resend OTP
  void _resendOtp() {
    ...
    SnackbarUtils.showInfo(context, "New OTP sent 🔄");
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Enter the 4 digit code sent to ${widget.userInput}",
                        ...
                        _canResend
                          ...
                          child: const Text(
                            ...
                            : Text("Code expires in $_remainingSeconds s",
                            style: const TextStyle(
